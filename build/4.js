webpackJsonp([4],Array(314).concat([
/* 314 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewComplaintModule", function() { return ViewComplaintModule; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view__ = __webpack_require__(484);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__custom_image_image_module__ = __webpack_require__(472);
...
var ViewComplaintModule = /** @class */ (function () {
    function ViewComplaintModule() {
    }
    ViewComplaintModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_3__view__["a" /* ViewComplaintPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_angular2_moment__["MomentModule"],
                __WEBPACK_IMPORTED_MODULE_4__custom_image_image_module__["a" /* ImageHandlerModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__view__["a" /* ViewComplaintPage */])
            ],
        })
    ], ViewComplaintModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewComplaintPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_custom_service__ = __webpack_require__(42);
...
var ViewComplaintPage = /** @class */ (function (_super) {
    __extends(ViewComplaintPage, _super);
    function ViewComplaintPage(params, complaintService, viewCtrl, alertCtrl, mdlCtrl, actionSheetCtrl, events, customService, authService) {
        ...
        _this.title = "View " + _this.complaintService.compOrSugg;
        _this.statusChangedByLive = false;
        ...
        var complaintTemp = _this.params.get('viewCompl');
        _this.complaintIndex = _this.params.get('index');
        _this.complaintList = _this.params.get('list');
        _this.fetchCompleteComplaint(complaintTemp.id);
        return _this;
    }
    ViewComplaintPage.prototype.fetchCompleteComplaint = function (id) {
        var _this = this;
    ...
    //     });
    // }
    ViewComplaintPage.prototype.comment = function () {
        var _this = this;
        this.openCommentPage()
            .onDidDismiss(function (updatedComplaint) {
            if (updatedComplaint) {
                // update the current complaint
                _this.complaint = updatedComplaint;
                // replace the currenlty opened complaint from the list with 
                // the updated complaint by using index
                _this.complaintList.splice(_this.complaintIndex, 1, updatedComplaint);
            }
        });
    };
    ViewComplaintPage.prototype.edit = function () {
        var _this = this;
        this.editComplaint()
            .onDidDismiss(function (updatedComplaint) {
            if (updatedComplaint) {
    ...
    ViewComplaintPage.prototype.close = function () {
        var _this = this;
        this.openClosePage()
            .onDidDismiss(function (updatedComplaint) {
            if (updatedComplaint) {
    ...
    ViewComplaintPage.prototype.dismiss = function () {
    ...
    ViewComplaintPage.prototype.disconnectSockJs = function () {
    ...
    ViewComplaintPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_custom_service__["a" /* CustomService */],
            __WEBPACK_IMPORTED_MODULE_5__providers_auth_service__["a" /* AuthService */]])
    ], ViewComplaintPage);
    return ViewComplaintPage;
