webpackJsonp([0,2,11,17,20],Array(303).concat([
/* 303 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComplaintMainModule", function() { return ComplaintMainModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_moment__ = __webpack_require__(461);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__compl_suggestion_options_compl_suggestion_options_module__ = __webpack_require__(304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__complaint_main__ = __webpack_require__(468);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__no_results_no_results_module__ = __webpack_require__(469);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ComplaintMainModule = /** @class */ (function () {
    function ComplaintMainModule() {
    }
    ComplaintMainModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_4__complaint_main__["a" /* ComplaintMainPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_5__no_results_no_results_module__["a" /* NoResultsModule */],
                // SortFilterOptionsModule,
                __WEBPACK_IMPORTED_MODULE_2_angular2_moment__["MomentModule"],
                __WEBPACK_IMPORTED_MODULE_3__compl_suggestion_options_compl_suggestion_options_module__["ComplaintSuggestionOptionsModule"],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__complaint_main__["a" /* ComplaintMainPage */])
            ],
            exports: [__WEBPACK_IMPORTED_MODULE_4__complaint_main__["a" /* ComplaintMainPage */]]
        })
    ], ComplaintMainModule);
    return ComplaintMainModule;
}());

//# sourceMappingURL=complaint-main.module.js.map
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SuggestionsModule", function() { return SuggestionsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__suggestions__ = __webpack_require__(483);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__complaint_main_complaint_main_module__ = __webpack_require__(305);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__change_role_change_role_module__ = __webpack_require__(303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sort_filter_options_sort_filter_module__ = __webpack_require__(306);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SuggestionsModule = /** @class */ (function () {
    ...
    SuggestionsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__suggestions__["a" /* SuggestionsPage */]],
            imports: [
                // SortFilterOptionsModule,
                __WEBPACK_IMPORTED_MODULE_3__complaint_main_complaint_main_module__["ComplaintMainModule"],
                __WEBPACK_IMPORTED_MODULE_4__change_role_change_role_module__["ChangeRoleModule"],
                __WEBPACK_IMPORTED_MODULE_5__sort_filter_options_sort_filter_module__["SortFilterOptionsModule"],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__suggestions__["a" /* SuggestionsPage */])
            ],
        })
    ], SuggestionsModule);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(462)(module)))
...
var moment = __webpack_require__(324);
...
;(function (global, factory) {
    true ? factory(__webpack_require__(324)) :
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ComplaintMainPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
...
var ComplaintMainPage = /** @class */ (function () {
    function ComplaintMainPage(mdlCtrl, navCtrl, toastCtrl, complaintService, customService, events) {
        this.mdlCtrl = mdlCtrl;
        ...
        this.refreshMsgDisplayed = false;
        this.debounceDuration = 400;
        this.getComplaints(1);
    }
    ComplaintMainPage.prototype.onSortFilterSelect = function (event) {
        var _this = this;
        if (event.sortName) {
            if (event.sortName === 'clear') {
                ...
                this.complaintService.sortBy(event.sortName, 1)
                    ...
                    _this.isEmptyList = _this.complaintList.length == 0;
                    _this.appliedSortName = event.sortName;
            ...
            if (event.filter.filterName === 'clear') {
                ...
                this.complaintService.filterBy(event.filter.filterName, event.filter.id, 1)
                    ...
                    _this.complaintList = res;
                    _this.isEmptyList = _this.complaintList.length == 0;
                    _this.appliedFilter = event.filter;
                    _this.isFilterApplied = true;
                    _this.isSortApplied = false;
                    _this.searchInput = '';
                    _this.customService.hideLoader();
                    // this.showSortFilterRemoveMsg();
                    _this.currentPage = 1;
    ...
    ComplaintMainPage.prototype.getComplaints = function (pageNo, refresher) {
        var _this = this;
        if (!refresher) {
            this.customService.showLoader();
        }
    ...
    //     });
    // }
    ComplaintMainPage.prototype.openViewModal = function (complaint, index) {
    ...
    ComplaintMainPage.prototype.doRefresh = function (refresher) {
    ...
    ComplaintMainPage.prototype.doInfinite = function (refresher) {
        var _this = this;
        if (this.searchInput.trim().length >= 1) {
            ...
            if (this.isSortApplied) {
                this.complaintService.sortBy(this.appliedSortName, this.currentPage + 1)
                    ...
                    if (res && res.length) {
                        _this.currentPage++;
                        _this.complaintList = _this.complaintList.concat(res);
                    }
                }, function (err) {
                    refresher.complete();
                    _this.customService.showToast(err.msg);
    ...
    ComplaintMainPage.prototype.onSearchInput = function (event) {
    ...
    ComplaintMainPage.prototype.sendSearchRequest = function () {
    ...
    ComplaintMainPage.prototype.sendSearchAfterFilterRequest = function () {
        // this.currentPageWithSearch = 1;
        // this.searchInProcess = true;
    ...
    ComplaintMainPage.prototype.onSearchClear = function (event) {
        // if (this.isFilterApplied) {
        //     this.customService.showLoader();
    ...
    return ComplaintMainPage;
}());

//# sourceMappingURL=complaint-main.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NoResultsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__no_results_component__ = __webpack_require__(470);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NoResultsModule = /** @class */ (function () {
    function NoResultsModule() {
    }
    NoResultsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__no_results_component__["a" /* NoResultsComponent */]],
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__no_results_component__["a" /* NoResultsComponent */])],
            exports: [__WEBPACK_IMPORTED_MODULE_2__no_results_component__["a" /* NoResultsComponent */]]
        })
    ], NoResultsModule);
    return NoResultsModule;
}());

//# sourceMappingURL=no-results.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__complaint_main_complaint_main__ = __webpack_require__(468);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_complaint_service__ = __webpack_require__(105);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SuggestionsPage = /** @class */ (function () {
    function SuggestionsPage(complaintService) {
        this.complaintService = complaintService;
        this.searchInput = '';
        this.debounceDuration = 400;
    ...
    SuggestionsPage.prototype.onRoleChanged = function (ev) {
        this.complaintMainPage.currentPage = 1;
        this.complaintMainPage.getComplaints(1);
    };
    SuggestionsPage.prototype.onSortFilterSelect = function (event) {
    ...
    // }
    SuggestionsPage.prototype.doRefresh = function (refresher) {
        this.complaintMainPage.doRefresh(refresher);
        this.searchInput = '';
    };
    SuggestionsPage.prototype.onSearchInput = function (event) {
        this.complaintMainPage.onSearchInput(event);
    };
    SuggestionsPage.prototype.onSearchClear = function (event) {
        this.complaintMainPage.onSearchClear(event);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_1__complaint_main_complaint_main__["a" /* ComplaintMainPage */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1__complaint_main_complaint_main__["a" /* ComplaintMainPage */])
    ], SuggestionsPage.prototype, "complaintMainPage", void 0);
    SuggestionsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Users/alkagirdhar/Desktop/akash/kabaliwala/src/pages/management/suggestions/suggestions.html"*/'<ion-header>\n      <ion-navbar color="primary">\n        <button ion-button icon-only menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title no-lines>\n          {{title | titlecase}}\n        </ion-title>\n        \n        <ion-buttons end >\n            <change-role (roleChanged)="onRoleChanged($event)"></change-role>\n        </ion-buttons>\n        \n      </ion-navbar>\n    </ion-header>\n    \n  \n  \n  <ion-content class="gray-back">\n    <ion-refresher (ionRefresh)="doRefresh($event)">\n      <ion-refresher-content></ion-refresher-content>\n    </ion-refresher>\n    <complaint-main [complaintList]="complaintList" [searchInput]="searchInput"></complaint-main>\n  </ion-content>\n  <sort-filter  [sortSelected]="complaintMainPage.isSortApplied" [filterSelected]="complaintMainPage.isFilterApplied" (onSelect)="onSortFilterSelect($event)"></sort-filter>\n'/*ion-inline-end:"/Users/alkagirdhar/Desktop/akash/kabaliwala/src/pages/management/suggestions/suggestions.html"*/
        }),
