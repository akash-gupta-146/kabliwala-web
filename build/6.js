webpackJsonp([6],Array(308).concat([
/* 308 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__comments__ = __webpack_require__(478);
...
var CommentsModule = /** @class */ (function () {
    ...
    CommentsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_3__comments__["a" /* CommentsPage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_angular2_moment__["MomentModule"],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__comments__["a" /* CommentsPage */])
            ],
        })
    ], CommentsModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_custom_http_service__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CommentsPage = /** @class */ (function () {
    function CommentsPage(navParam, viewCtrl, alertCtrl, events, complaintService, customService, customHttp) {
        ...
        this.title = "COMMENTS";
        this.inputChat = '';
        this.complaintClosed = false; // used only for handling comment count in case complaint is closed with a comment
        this.userInfo = JSON.parse(localStorage.getItem('userInfo'));
        this.postInProcess = false; //to show spinner while sending the message
    ...
    CommentsPage.prototype.getComments = function () {
        ...
        this.complaintService.fetchComments(this.complaint.id)
            ...
            _this.comments = res;
            _this.isCommentsEmpty = _this.comments.length == 0;
            _this.customService.hideLoader();
            setTimeout(function () {
                _this.content.scrollToBottom();
            }, 100);
            _this.checkComplaintStatus();
        }, function (err) {
            _this.customService.showToast(err.msg);
            _this.customService.hideLoader();
        });
    };
    CommentsPage.prototype.checkComplaintStatus = function () {
    ...
    CommentsPage.prototype.sockJsConnection = function () {
        var _this = this;
        this.stompClient = this.customHttp.getSockJs();
        var url1 = "/" + URLPREFIX + "/" + this.complaintService.compOrSugg + "/" + this.complaint.id + "/close";
        var url2 = "/" + URLPREFIX + "/" + this.complaintService.compOrSugg + "/" + this.complaint.id + "/comment";
        this.stompClient.connect({}, function (frame) {
            _this.stompClient.subscribe(url1, function (greeting) {
                var message = JSON.parse(greeting.body);
                if (!message) {
                    return;
                }
                _this.complaint = message;
                _this.complaintClosed = true;
                _this.showPrompt();
                _this.content.scrollToBottom();
            });
            _this.stompClient.subscribe(url2, function (greeting) {
                var message = JSON.parse(greeting.body);
                if (!message) {
                    return;
                }
                ...
                _this.content.scrollToBottom();
                _this.isCommentsEmpty = _this.comments.length == 0;
                if (!_this.complaintClosed) {
                    _this.complaint.commentCount++;
                }
            });
        });
    };
    ...
    CommentsPage.prototype.postChat = function () {
        var _this = this;
        var msg = this.inputChat;
        this.inputChat = '';
        ...
        this.complaintService.postComments(this.complaint.id, msg)
            ...
            _this.complaint.commentCount++;
            _this.isCommentsEmpty = false;
            _this.showRecentPost({
                comment: msg,
                employeeId: _this.selfId || null,
                employeeName: _this.userInfo.name || null,
                employeePicUrl: _this.userInfo.picUrl || null,
            });
            setTimeout(function () {
                _this.content.scrollToBottom();
            }, 100);
    ...
    CommentsPage.prototype.showRecentPost = function (commentData) {
    ...
    CommentsPage.prototype.dismiss = function (updatedComplaint) {
        this.disconnectSockJs();
        this.viewCtrl.dismiss(updatedComplaint);
    };
    CommentsPage.prototype.disconnectSockJs = function () {
    ...
    CommentsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_custom_http_service__["a" /* CustomHttpService */]])
    ], CommentsPage);
    return CommentsPage;
}());
