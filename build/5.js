webpackJsonp([5,20],Array(303).concat([
/* 303 */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppreciationsModule", function() { return AppreciationsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appreciation__ = __webpack_require__(477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_moment__ = __webpack_require__(461);
...
var AppreciationsModule = /** @class */ (function () {
    function AppreciationsModule() {
    }
    AppreciationsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__appreciation__["a" /* AppreciationsPage */]],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__appreciation__["a" /* AppreciationsPage */])
            ],
        })
    ], AppreciationsModule);
    return AppreciationsModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AppreciationsPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_custom_service__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_appreciation_service__ = __webpack_require__(215);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppreciationsPage = /** @class */ (function () {
    function AppreciationsPage(customService, appreciationService) {
        this.customService = customService;
        this.appreciationService = appreciationService;
        this.pageNo = 1;
        this.getAppreciations();
    }
    AppreciationsPage.prototype.onRoleChanged = function (ev) {
        this.pageNo = 1;
        this.getAppreciations();
    };
    AppreciationsPage.prototype.getAppreciations = function (refresher) {
        var _this = this;
        if (!refresher) {
    ...
    AppreciationsPage.prototype.doRefresh = function (refresher) {
        this.getAppreciations(refresher);
    };
    AppreciationsPage.prototype.doInfinite = function (refresher) {
        var _this = this;
        this.appreciationService.getAppreciations(this.pageNo + 1)
            .subscribe(function (res) {
            if (res && res.length != 0) {
                _this.appreciationList = _this.appreciationList.concat(res);
                _this.pageNo++;
            }
            refresher.complete();
        }, function (err) {
    ...
    AppreciationsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Users/alkagirdhar/Desktop/akash/kabaliwala/src/pages/management/appreciation/appreciation.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title no-lines>\n      Appreciations\n    </ion-title>\n    <ion-buttons end >\n        <change-role (roleChanged)="onRoleChanged($event)"></change-role>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class=" gray-back ">\n  <ion-refresher (ionRefresh)="doRefresh($event)">\n    <ion-refresher-content></ion-refresher-content>\n  </ion-refresher>\n<img src="assets/imgs/star.png" class="pic-back" />\n  <div class="appreciation-card" *ngFor="let appr of appreciationList">\n      <div class="date">{{appr.createdAt | amDateFormat:\'LL\' }}</div>\n      <div class="appreciation">\n        <div class="image">\n          ★\n        </div>\n        <div class="details">\n          <h4>{{appr.title}}</h4>\n          <p>{{appr.description}}</p>\n        </div>\n      </div>\n        <div class="contact-details">\n         <div class="store">\n           <h5>{{appr.storeName}}</h5>\n           <p><ion-icon name="home"></ion-icon> {{appr.storeLocation}}</p>\n        </div>\n        <div class="guest">\n          <h5 *ngIf="appr.visitorName">{{appr.visitorName}}</h5>\n          <div class="phone" *ngIf="appr.visitorContactNo"><ion-icon name="call"> </ion-icon> : {{appr.visitorContactNo}}</div>\n          <div class="email" *ngIf="appr.visitorEmail"><ion-icon name="mail"> </ion-icon> : {{appr.visitorEmail}}</div>\n        </div>\n      </div>\n    </div>\n\n\n  <ion-list class="no-comment" *ngIf="appreciationList?.length==0">\n    <ion-icon name="list-box"></ion-icon>\n    <br>NO RECORD FOUND\n  </ion-list>\n\n  <ion-infinite-scroll (ionInfinite)="doInfinite($event)">\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>'/*ion-inline-end:"/Users/alkagirdhar/Desktop/akash/kabaliwala/src/pages/management/appreciation/appreciation.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__providers_custom_service__["a" /* CustomService */],
            __WEBPACK_IMPORTED_MODULE_2__providers_appreciation_service__["a" /* AppreciationService */]])
    ], AppreciationsPage);
